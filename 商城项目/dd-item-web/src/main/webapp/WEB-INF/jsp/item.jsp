...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/cloud-zoom.1.0.2.min.js" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/jquery.thickbox.js" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/goods.js" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/NewVersion.js" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/png.js" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/qiangGouPro.js" type="text/javascript"></script>
	...
	<script src="${pageContext.request.contextPath}/js/shadow.js" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/product.js" type="text/javascript"></script>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/base_w1200.css"></link>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/product.css"></link>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/jquery.alerts.css"></link>
...
<div class="pWrap">
    ...
    <div class="main-box">
		...
		<div class="pCont cpjs_box" id="div-detail">
			...
			<div class="product_info">${item.desc }</div>
		</div>
