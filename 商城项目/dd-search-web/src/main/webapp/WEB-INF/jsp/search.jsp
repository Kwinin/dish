	...
	<div class="linknav">
		<div class="schArticle">
			<a href="/article/search?keyword=%E6%9C%88%E9%A5%BC" target="_blank">找到和“<span>${query}</span>”相关的文章<span
				id="articlenum">${result.totalPage}</span>篇&gt;&gt;
			</a>
		</div>
	...
	<div class="content_list">
		<div class="main-box">
			...
			<div class="r-filter">
				<div class="f-sort">
					<div class="pagin">
						<span class="txt"><span class="n">${page}</span>/${result.totalPage}</span>
					...
					<c:forEach items="${result.itemList}" var="item">
						<li>
							<div class="l-wrap">
								<div class="pic">
									<a class="trackref"
										href="http://localhost:8083/ddshop/item/${item.id}.html" title=""
								...
								<div class="title-a">
									<a class="trackref presaleSign_225865"
										href="http://localhost/${item.id}.html"
										target="_blank">${item.title }</a>
								</div>
								<div class="title-b" style="">
									<a class="trackref"
										href="http://localhost/${item.id}.html"
										target="_blank">${item.sellPoint }</a>
								</div>
								<div class="comment">
